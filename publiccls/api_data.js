define({ "api": [
  {
    ...
    "title": "Autentica o usuário no sistema",
    "name": "Authenticate",
    "group": "User",
    "parameter": {
      "fields": {
  ...
  },
  {
    "type": "put",
    "url": "api/user/:id",
    "title": "Altera um usuário pelo id",
    "name": "DeleteUser",
    "group": "User",
    "parameter": {
      "fields": {
  ...
  },
  {
    "type": "delete",
    "url": "api/user/:id",
    "title": "Delete um usuário pelo id",
    "name": "DeleteUser",
    "group": "User",
    "parameter": {
      "fields": {
  ...
  },
  {
    "type": "get",
    "url": "api/user/:id",
    "title": "Requisita a informação de um usuário",
    "name": "GetUser",
    "group": "User",
    "parameter": {
      "fields": {
  ...
  },
  {
    "type": "get",
    "url": "api/user",
    "title": "Request Requisita a lista de usuários do sistema",
    "name": "GetUsers",
    "group": "User",
    "header": {
      "fields": {
  ...
  },
  {
    "type": "post",
    "url": "api/user",
    "title": "Cadastra um novo usuário no sistema",
    "name": "PostUser",
    "group": "User",
    "parameter": {
      "fields": {
